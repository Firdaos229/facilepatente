                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Modifica un corso</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('courses.update', $course->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="number" name="total_courses" class="form-control"
                                        value="{{ old('total_courses', $course->total_courses) }}" placeholder="Ex: 10"
                                        required min="1">
                                </div>
                            </div>
