...
@foreach($produitsParVendeur as $vendeurId => $produits)
        ...
        @foreach($produits as $produitCommande)
                    <li>
                        ...
                        <strong>Nom Produit:</strong> {{ $produitCommande->produit->nom }} <img src="{{asset('storage/' . $produitCommande->produit_image )}} " width="5%" alt="image du produit"> <br>
                        <strong>Quantité:</strong> {{ $produitCommande->quantite }} <br>
                        <strong>Prix:</strong> {{ $produitCommande->prix }} XOF <br>
                        <strong>Montant Total:</strong> {{ $produitCommande->prix * $produitCommande->quantite }} XOF <br>
