                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">LISTE DES COMMANDES</a></li>
...
@else
                    ...
                    <tr>
                     ...
                     <td>{{$commande->Acheteur_numero}}</td>
...
<td>  @if ($commande->statut == 0)
      ...
      <div class="col-sm-6 col-xs-6 text-right tot"> {{ $commandes->links('pagination::bootstrap-4') }}</div>
    </div>
