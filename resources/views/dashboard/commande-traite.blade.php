...
@section('content')
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Liste des commandes traité</a></li>
       ...
       <div class="table-responsive">
                  <table class="table align-middle mb-0">
                   <thead class="table-light">
                    ...
                    <tbody>
                    @foreach ($commandestraites as $commande)
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
    ...
    <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0"/>
      ...
      <div class="col-sm-6 col-xs-6 text-right tot"> {{ $commandestraites->links('pagination::bootstrap-4') }}</div>
    </div>
